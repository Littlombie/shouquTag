...
>由于本人一直使用收趣云书签来存储自己稍后阅读（不读）的文章博客（拖延症太重了），但是最近发现收趣已经好久没有更新了，所以需要导出来以备后边访问万一不了了，但由于收趣的导出是收费功能，所以就自己写了小脚本，自动导出数据。
...
页面是每30ms向下滑动100像素，然后出发下拉下载更多，此处有可能根据网速问题会频繁执行，可以根据网速自行设置。